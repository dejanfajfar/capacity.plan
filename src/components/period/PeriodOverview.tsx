      ...
      notifications.show({
        ...
        message:
          error instanceof Error
            ? error.message
            : "Failed to delete planning period",
        color: "red",
      });
    }
  };
  ...
  return (
    <Stack gap="md">
      ...
      {stats.requirementsCount === 0 && (
        <Paper p="md" withBorder bg="blue.0">
          <Text size="sm" c="blue.9">
            <strong>Next Step:</strong> Go to the "Project Requirements" tab to
            set required hours for each project in this planning period.
          </Text>
        </Paper>
      )}
      ...
      {stats.requirementsCount > 0 && stats.assignmentsCount === 0 && (
        <Paper p="md" withBorder bg="blue.0">
          <Text size="sm" c="blue.9">
            <strong>Next Step:</strong> Go to the "Assignments" tab to assign
            people to projects for this planning period.
          </Text>
        </Paper>
      )}
    </Stack>
